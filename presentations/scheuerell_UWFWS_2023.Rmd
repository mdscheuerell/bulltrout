...
* ### .orange-text[population trends] .gray-text[, distribution, demographics & genetics]
...
# Most of the data are gappy

```{r data_gappy, dpi=300, fig.height=4, fig.width=8, out.height="100%", out.width="100%", fig.align='center', echo=FALSE, warning=FALSE}
nn <- 20
tt <- rpois(nn, 10)
na <- sample(tt, 5)
tt[na] <- NA
