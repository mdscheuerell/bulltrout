...
Further defining $w_t \sim \text{N}(0, q)$ leads us to a so-called "biased random walk" model, where $u$ is the tendency for the population to increase or decrease each time step (i.e., the bias).
