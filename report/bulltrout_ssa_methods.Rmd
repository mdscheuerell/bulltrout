...
The following pages contain plots of standardized indices of log-abundance for adults over time by core area (i.e., location given by `State: Core area`. Fitted trend lines (black) and associated 90% confidence intervals (gray) are also shown.
...
The following pages contain plots of standardized indices of log-abundance for juveniles over time by core area (i.e., location given by `State: Core area`. Fitted trend lines (black) and associated 90% confidence intervals (gray) are also shown.
