...
Estimated trends in abundance were rather mixed (Tables 1-4), such that 37 out of 62 core areas showed decreasing trends, but only 3 of trends had 90% CI's that did not overlap 0. The remaining 25 core areas had decreasing trends, but only 5 of them had 90% CI's that did not overlap 0. Model trend lines and their associated CI's are provided at the end of this report.
...
state_core_popn <- stringr::str_split_fixed(tbl_res$X, pattern = ": ", 3) %>%
  as.data.frame()
colnames(state_core_popn) <- c("state", "domain", "popn")
...
kableExtra::kable(tbl_res_MT, booktabs = TRUE,
                  ...
                  align = "lcccc",
                  caption = "Estimated trends and uncertainty for core areas in Montana. The trend column indicates if the estimated trend was significantly positive (+), negative (-), or neutral (0).")
...
kableExtra::kable(tbl_res_MT, booktabs = TRUE,
                  col.names = c("Core area", "Lower CI", "Mean", "Upper CI", "Trend"),
                  align = "lcccc",
                  caption = "Estimated trends and uncertainty for core areas in Idaho. The trend column indicates if the estimated trend was significantly positive (+), negative (-), or neutral (0).")
...
kableExtra::kable(tbl_res_WA, booktabs = TRUE,
                  col.names = c("Core area", "Lower CI", "Mean", "Upper CI", "Trend"),
                  align = "lcccc",
                  caption = "Estimated trends and uncertainty for core areas in Washington. The trend column indicates if the estimated trend was significantly positive (+), negative (-), or neutral (0).")
...
kableExtra::kable(tbl_res_OR, booktabs = TRUE,
                  col.names = c("Core area", "Lower CI", "Mean", "Upper CI", "Trend"),
                  align = "lcccc",
                  caption = "Estimated trends and uncertainty for core areas in Oregon. The trend column indicates if the estimated trend was significantly positive (+), negative (-), or neutral (0).")
```
