...
All models were fit using the `{MARSS}` package `r citep(citation("MARSS"))` for the **R** computing software `r citep(citation())`. All of the data and code necessary to reproduce the results of the analysis can be found online at https://github.com/mdscheuerell/bulltrout.
