...
The adult data come from 242 populations within 62 core area spread across the 6 recovery domains. Thus, $\mathbf{y}_t$ is a 242 $\times$ 1 vector of transformed observed counts in year $t$, and $\mathbf{x}_t$ is a 62 $\times$ 1 vector of underlying states in year $t$. The matrix $\mathbf{Z}$ is a 242 $\times$ 62 matrix of 1's and 0's that maps each of the respective observations onto their respective states.

The juvenile data are much more restricted, coming from 38 populations within 19 core area spread across the 6 recovery domains. Thus, $\mathbf{y}_t$ is a 38 $\times$ 1 vector of transformed observed counts in year $t$, and $\mathbf{x}_t$ is a 38 $\times$ 1 vector of underlying states in year $t$. The matrix $\mathbf{Z}$ is a 38 $\times$ 19 matrix of 1's and 0's that maps each of the respective observations onto their respective states.
...
Estimated trends in adult abundance were rather mixed (Tables 1-4), such that 37 out of 62 core areas showed decreasing trends, but only 3 of trends had 90% CI's that did not overlap 0. The remaining 25 core areas had decreasing trends, but only 5 of them had 90% CI's that did not overlap 0. Fitted trend lines and their associated CI's are provided at the end of this report.


## Juvenile abundance

Estimated trends in juvenile abundance were also rather mixed (Table 5), such that 37 out of 62 core areas showed decreasing trends, but only 3 of trends had 90% CI's that did not overlap 0. The remaining 25 core areas had decreasing trends, but only 5 of them had 90% CI's that did not overlap 0. Fitted trend lines and their associated CI's are provided at the end of this report.
...
```{r tbl_results_adults, results = 'hold'}
library(dplyr)
...
kableExtra::kable(tbl_res_MT, booktabs = TRUE,
                  ...
                  align = "lcccc",
                  caption = "Estimated trends and uncertainty for adult bull trout in core areas in Montana. The trend column indicates if the estimated trend was significantly positive (+), negative (-), or neutral (0).") %>%
...
kableExtra::kable(tbl_res_MT, booktabs = TRUE,
                  col.names = c("Core area", "Lower CI", "Mean", "Upper CI", "Trend"),
                  align = "lcccc",
                  caption = "Estimated trends and uncertainty for adult bull trout in core areas in Idaho. The trend column indicates if the estimated trend was significantly positive (+), negative (-), or neutral (0).") %>%
  kableExtra::kable_styling(latex_options = "HOLD_position")
...
kableExtra::kable(tbl_res_WA, booktabs = TRUE,
                  col.names = c("Core area", "Lower CI", "Mean", "Upper CI", "Trend"),
                  align = "lcccc",
                  caption = "Estimated trends and uncertainty for adult bull trout in core areas in Washington. The trend column indicates if the estimated trend was significantly positive (+), negative (-), or neutral (0).") %>%
  kableExtra::kable_styling(latex_options = "HOLD_position")
...
kableExtra::kable(tbl_res_OR, booktabs = TRUE,
                  col.names = c("Core area", "Lower CI", "Mean", "Upper CI", "Trend"),
                  align = "lcccc",
                  caption = "Estimated trends and uncertainty for adult bull trout in core areas in Oregon. The trend column indicates if the estimated trend was significantly positive (+), negative (-), or neutral (0).") %>%
  kableExtra::kable_styling(latex_options = "HOLD_position")
...
kableExtra::kable(tbl_res_j, booktabs = TRUE,
                  ...
                  align = "llcccc",
                  caption = "Estimated trends and uncertainty for juvenile bull trout in Idaho, Washington, and Oregon. The trend column indicates if the estimated trend was significantly positive (+), negative (-), or neutral (0).") %>%
  kableExtra::kable_styling(latex_options = "HOLD_position")
