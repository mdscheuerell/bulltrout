...
The following pages contain plots of standardized indices of log-abundance for juveniles over time by core area (i.e., location indicated on plots by `State: Core area`). Fitted trend lines (black) and associated 90% confidence intervals (gray) are also shown.
